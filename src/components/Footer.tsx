                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-xl font-bold text-foreground tracking-tight">ToolNova</span>
                        </div>
                        <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mb-6">
                            The smartest way to study and create. AI-powered tools designed to boost your productivity and help you achieve more.
                        </p>
                        <div className="flex gap-3">
                            <a href="#" className="h-10 w-10 flex items-center justify-center rounded-xl bg-slate-100 dark:bg-slate-800 text-muted-foreground hover:bg-primary hover:text-white transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link href="/tools" className="text-muted-foreground hover:text-primary transition-colors text-sm">All Tools</Link></li>
