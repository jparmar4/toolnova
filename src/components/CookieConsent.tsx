...
export function CookieConsent() {
    ...
    useEffect(() => {
        // Check if user has already explicitly accepted/declined
        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 w-full bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-50 p-4 md:p-6"
                >
