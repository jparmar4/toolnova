...
export const metadata: Metadata = {
    title: "Blog - Tips, Guides & Tutorials | ToolNova",
    description: "Expert guides on AI tools, productivity, writing, and study tips. Learn how to use free AI tools effectively to boost your productivity and achieve your goals.",
    keywords: ["AI tools blog", "productivity tips", "study guides", "writing tips", "AI guides", "free tools tutorials"],
    openGraph: {
        title: "Blog - Tips, Guides & Tutorials | ToolNova",
