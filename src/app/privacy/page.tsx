...
export const metadata = {
    ...
    description: "Privacy Policy for ToolNova. Learn how we collect, use, and protect your data.",
};
        ...
        <div className="container mx-auto px-6 py-24 max-w-4xl text-slate-800 dark:text-slate-200">
            ...
            <div className="prose dark:prose-invert max-w-none space-y-6">
                <section>
                    ...
                    <p>
                        Welcome to ToolNova ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy.
                        ...
                        please contact us at support@toolnovahub.com.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 mt-2 space-y-2">
                        <li><strong>Personal Information Provided by You:</strong> Names, email addresses, verify passwords, and other similar information.</li>
                        <li><strong>Automated Information:</strong> IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our website.</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Like any other website, ToolNova uses 'cookies'. These cookies are used to store information including visitors' preferences,
                ...
                <section>
                    ...
                    <p>
                        You may consult this list to find the Privacy Policy for each of the advertising partners of ToolNova.
                    </p>
                    <p className="mt-2">
                        ...
                        advertisements and links that appear on ToolNova, which are sent directly to users' browser. They automatically receive your
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">7. CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold mb-4">8. GDPR Data Protection Rights</h2>
