        ...
        <div className="container mx-auto px-6 py-24 max-w-5xl">
            ...
            <div className="text-center mb-20">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                    ToolNova is an all-in-one platform built to empower students, creators, and professionals with professional-grade AI tools.
                </p>
            </div>
            ...
            <div className="max-w-3xl mx-auto prose dark:prose-invert">
                <h2>Our Story</h2>
                <p>
                    ToolNova started with a simple idea: AI tools shouldn't be scattered across dozens of expensive subscriptions.
