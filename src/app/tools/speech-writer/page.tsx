...
export const metadata: Metadata = {
  title: 'AI Speech Writer – Write Speeches Free | AI Study Tools',
  ...
  alternates: { canonical: 'https://aimultitools.com/tools/speech-writer' },
};

const toolSchema = getToolSchema('AI Speech Writer', 'Write compelling speeches for any occasion', 'https://aimultitools.com/tools/speech-writer');
