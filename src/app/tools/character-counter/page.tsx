...
const toolSchema = getToolSchema('Character Counter', 'Count characters, words, and check social media limits', 'https://www.toolnovahub.com/tools/character-counter');
