...
export const metadata: Metadata = {
    title: 'AI Paragraph Generator – Write Perfect Paragraphs Free | AI Writing Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/paragraph-generator' },
};

const toolSchema = getToolSchema('AI Paragraph Generator', 'Generate well-structured paragraphs on any topic', 'https://aimultitools.com/tools/paragraph-generator');
