...
export const metadata = {
    title: 'All Tools - Free AI & PDF Tools | AI Multi Tools',
    description: 'Explore our 45+ free tools for study, writing, exam prep, image editing, PDF management, and career development.',
};
...
const categories = [
    {
        name: 'Study Tools',
        slug: 'study-tools',
        description: 'AI-powered tools for homework, notes, flashcards, quizzes, and more.',
        icon: GraduationCap,
        count: 11,
    ...
    },
    {
        name: 'Writing Tools',
        slug: 'writing-tools',
        description: 'Create essays, stories, emails, captions, and professional content.',
        icon: Pencil,
        count: 10,
        gradient: 'from-purple-500 to-pink-600',
        bgLight: 'from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/10',
    ...
    },
    {
        ...
        bgLight: 'from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/10',
    ...
    },
    {
        name: 'Career Tools',
        slug: 'career-tools',
        description: 'Cover letters, interview prep, goal planning, and productivity.',
        icon: Briefcase,
        count: 6,
        gradient: 'from-amber-500 to-yellow-600',
        bgLight: 'from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/10',
            ...
            <div className="mx-auto max-w-[1200px] px-6 py-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
                        Explore our comprehensive collection of AI-powered tools designed for students, writers, and professionals.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {categories.map((category, index) => (
                        ...
                        >
                            ...
                            {/* Tool count badge */}
                            <div className={`absolute top-6 right-6 bg-gradient-to-r ${category.gradient} text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg`}>
                                {category.count} Tools
                            </div>

                            <div className="relative">
                                {/* Icon */}
                                <div className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${category.gradient} text-white shadow-xl ${category.shadowColor} group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                            ...
                            <div className="mt-8 flex items-center justify-between">
                                ...
                                <div className={`flex h-12 w-12 items-center justify-center rounded-full bg-white dark:bg-slate-800 text-primary shadow-lg group-hover:bg-gradient-to-r group-hover:${category.gradient} group-hover:text-white group-hover:scale-110 transition-all duration-300`}>
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center p-6 bg-white dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700">
                        ...
                        <p className="text-sm text-muted-foreground font-medium">Privacy First</p>
                    </div>
                </div>
            </div>
        </div>
