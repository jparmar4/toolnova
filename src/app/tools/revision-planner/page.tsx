...
export const metadata: Metadata = {
    title: 'AI Revision Planner – Create Study Schedule Free | AI Study Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/revision-planner' },
};

const toolSchema = getToolSchema('AI Revision Planner', 'Create personalized study schedules for exam preparation', 'https://aimultitools.com/tools/revision-planner');
