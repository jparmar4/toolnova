...
const toolSchema = getToolSchema('To-Do List Generator', 'Generate organized to-do lists from your goals', 'https://www.toolnovahub.com/tools/todo-list-generator');
