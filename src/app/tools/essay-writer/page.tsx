...
export const metadata: Metadata = {
  title:
    toolMeta?.title ||
    "Free AI Essay Writer – Generate Essays Instantly | ToolNova",
  description:
    toolMeta?.description ||
    "Write perfect essays instantly with our free AI essay writer. Get well-structured essays with intro, body, and conclusion. Fast, unique, and for students of all levels.",
  ...
  openGraph: {
    ...
    description:
      toolMeta?.description ||
      "Write perfect essays instantly with our free AI essay writer.",
  ...
  twitter: {
    ...
    description:
      "Generate structured essays instantly with intro, body, and conclusion.",
  },
};
