...
const toolSchema = getToolSchema('Age Calculator', 'Calculate exact age in years, months, and days from birth date', 'https://www.toolnovahub.com/tools/age-calculator');
