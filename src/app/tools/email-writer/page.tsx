...
export const metadata: Metadata = {
  title: 'AI Email Writer – Write Professional Emails Free | AI Study Tools',
  ...
  alternates: { canonical: 'https://aimultitools.com/tools/email-writer' },
};

const toolSchema = getToolSchema('AI Email Writer', 'Write professional emails for any situation', 'https://aimultitools.com/tools/email-writer');
