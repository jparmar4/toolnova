...
const toolSchema = getToolSchema('One Word Substitution', 'Find single words that replace lengthy phrases', 'https://www.toolnovahub.com/tools/one-word-substitution');
