...
export const metadata: Metadata = {
    title: 'JPG to PNG Converter – Convert JPEG to PNG Free | AI Multi Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/jpg-to-png' },
};

const toolSchema = getToolSchema('JPG to PNG Converter', 'Convert JPG/JPEG images to PNG format', 'https://aimultitools.com/tools/jpg-to-png');
