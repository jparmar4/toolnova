...
const toolSchema = getToolSchema('AI Concept Explainer', 'Break down complex topics into simple explanations', 'https://www.toolnovahub.com/tools/concept-explainer');
