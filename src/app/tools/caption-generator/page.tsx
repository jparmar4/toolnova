...
export const metadata: Metadata = {
  title: 'AI Caption Generator – Create Social Media Captions Free | AI Study Tools',
  ...
  alternates: { canonical: 'https://aimultitools.com/tools/caption-generator' },
};

const toolSchema = getToolSchema('AI Caption Generator', 'Generate engaging social media captions for any platform', 'https://aimultitools.com/tools/caption-generator');
