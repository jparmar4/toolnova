...
export const metadata: Metadata = {
    title: 'Interview Question Generator – Practice Interview Questions Free | AI Career Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/interview-generator' },
};

const toolSchema = getToolSchema('Interview Question Generator', 'Generate interview questions with sample answers', 'https://aimultitools.com/tools/interview-generator');
