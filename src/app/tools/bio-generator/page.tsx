...
export const metadata: Metadata = {
    title: 'AI Bio Generator – Create Catchy Social Media Bios Free | AI Writing Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/bio-generator' },
};

const toolSchema = getToolSchema('AI Bio Generator', 'Create catchy social media bios for any platform', 'https://aimultitools.com/tools/bio-generator');
