...
export const metadata: Metadata = {
    title: 'AI Formula Generator – Math & Science Formulas Free | AI Study Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/formula-generator' },
};

const toolSchema = getToolSchema('AI Formula Generator', 'Generate essential formulas for math and science topics', 'https://aimultitools.com/tools/formula-generator');
