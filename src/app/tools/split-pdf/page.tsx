...
export const metadata: Metadata = {
    title: 'Split PDF – Extract Pages Free Online | AI Multi Tools',
    ...
    alternates: { canonical: 'https://aimultitools.com/tools/split-pdf' },
};

const toolSchema = getToolSchema('Split PDF', 'Split PDF files into individual pages or extract page ranges', 'https://aimultitools.com/tools/split-pdf');
